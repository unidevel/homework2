    ...
    <div>
      ...
      <div className="row">
        <div className="col-lg-12">
          ...
          <Panel>
            <h3>Grid options</h3>
            <p>See how aspects of the Bootstrap grid system work across multiple
            ...
            <p>Grid classes apply to devices with screen widths greater than or equal to the
              ...
              Therefore, applying any
              <code>.col-md-</code> class to an element will not only affect its styling on
                medium devices but also on large devices if a
        ...
        <div className="col-lg-12">
          ...
          <Panel>
            ...
            <p>Using a single set of
              <code>.col-md-*</code> grid classes, you can create a default grid system that
                starts out stacked on mobile devices and tablet devices (the extra small to
                   small range) before becoming horizontal on desktop (medium) devices.
      ...
      <div className="row">
        <div className="col-lg-12">
          ...
          <Panel>
            ...
            <p>Dont want your columns to simply stack in smaller devices? Use the extra small and
      ...
      <div className="row">
        <div className="col-lg-12">
          ...
          <Panel>
            ...
            <p>Build on the previous example by creating even more dynamic and powerful
              layouts with tablet <code>.col-sm-*</code> classes.</p>
            <div className="row show-grid">
        ...
        <div className="col-lg-12">
          ...
          <Panel>
            ...
            <p>With the four tiers of grids available you're bound to run into issues where, at
              certain breakpoints, your columns don't clear quite right as one is taller than the
              other. To fix that, use a combination of a <code>.clearfix</code> and our
              <a href="" onClick={(e) => { e.preventDefault(); }}>responsive utility classes</a>.
            </p>
            <div className="row show-grid">
      ...
      <div className="row">
        <div className="col-lg-12">
          ...
          <Panel>
            ...
            <p>Move columns to the right using <code>.col-md-offset-*</code> classes.
              These classes increase the left margin of a column by <code>*</code> columns. For
              example, <code>.col-md-offset-4</code> moves <code>.col-md-4</code> over four columns.
            </p>
            <div className="row show-grid">
              <div className="col-md-4">.col-md-4</div>
